                            ...
                            <div class="card-dash-body">
                                ...
                                <div class="table-responsive">
                                    <div id="pending-table" style="color: black !important;">
                                        <table id="tabel-data-incoming"
                                            class="table table-bordered align-middle text-center display">
                                                        ...
                                                        <tr>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="tag pt-3 ps-5">
                                                                            ...
                                                                            <a href="" data-toggle="modal"
                                                                                data-target="#detailImageTracking<?= $data["sample_test"]; ?>">
                                                                                <img src="img/foto-sample/<?= $data["foto"]; ?>"
                                                                                    height="70" alt="">
                                                                            </a>

                                                                            <!-- detail image modal -->
                                                                            <div id="detailImageTracking<?= $data["sample_test"]; ?>"
                                                            ...
                                                            <td>
                                                                <button class="btn btn-warning btn-sm" data-toggle="modal"
                                                                    data-target="#remark<?= $data["sample_test"]; ?>">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div id="detailImage<?= $data["sample_test"]; ?>" class="modal fade"
                                                                    ...
                                                                    <div class="modal-dialog modal-lg">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h4 class="text-black">Image Sample (
                                                                                    <?= $data["sample_test"]; ?>)
                                                                                </h4>
                                                                                <button type="button" class="btn-close"
                                                                                    data-dismiss="modal"
