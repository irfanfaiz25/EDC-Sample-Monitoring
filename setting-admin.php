                                ...
                                <div class="row m-l-0 m-r-0">
                                    <div class="col-sm-4 bg-c-lite-green user-profile">
                                        <div class="card-block text-center text-white">
                                            <div class="m-b-25">
                                                <img src="img/user-img/<?= $row["foto"]; ?>" width="80" class="img-radius" alt="User-Profile-Image">
                                            </div>
                                            <h6 class="f-w-600"><?= $row["nama"]; ?></h6>
                                            <p><?= $row["level_user"]; ?></p>
                                        ...
                                        <div class="card-block">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 mt-2">
                                                    ...
                                                    <h6 class="text-muted f-w-400"><?= $row["username"]; ?></h6>
                                                </div>
                                                <div class="col-sm-6 mt-2">
                                                    <p class="m-b-10 f-w-600">Position</p>
                                                    <h6 class="text-muted f-w-400"><?= $row["level_user"]; ?></h6>
                                                </div>
                                                <div class="col-md-12">
                                                    <button class="btn btn-primary btn-sm float-end me-3 mt-xl-5" data-toggle="modal" data-target="#editUser<?= $row["id"]; ?>"><strong>EDIT </strong><i class="fa fa-gears"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-black">
                                        <div class="row">
                                            <div class="col-md-3 border-right">
                                                <div class="d-flex flex-column align-items-center text-center p-0 py-3 pt-0"><img class="img-radius mt-5" id="img" width="150px" src="img/user-img/<?= $row["foto"]; ?>"><span class="text-black pt-2"><?= $row["nama"]; ?></span><span class="text-black-50"><?= $row["level_user"]; ?></span><span></span></div>
                                            </div>
                                                ...
                                                <div class="p-3 py-5">
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row mt-3 text-black">
                                                            ...
                                                            <input type="text" name="foto_old" value="<?= $row["foto"]; ?>" hidden>
                                                            <div class="col-md-12"><label class="labels">Username</label>
                                                                <input type="text" class="form-control" name="username" placeholder="" value="<?= $row["username"]; ?>" disabled>
                                                            </div>
                                                            <div class="col-md-12"><label class="labels">Name</label>
                                                                <input type="text" class="form-control" name="nama" placeholder="" value="<?= $row["nama"]; ?>">
                                                            </div>
                                                            <div class="col-md-12"><label class="labels pt-2">Position</label>
                                                                <select class="form-select" aria-label=".form-select-sm example" name="level">
                                                                    <option selected><?= $row["level_user"]; ?></option>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-success" name="btn-update-admin"><i class="fa fa-floppy-disk"></i>
                                            SAVE</button>
                                        </form>
                                    </div>
                                </div>
